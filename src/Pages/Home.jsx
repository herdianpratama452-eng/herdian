...
const WORDS = ["Computer Engineering Technology Students", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/herdianpratama452-eng" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/herdian-pratama-35625a364/",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/herd1ann?igsh=dWcwY3hqWs3OHgw",
  },
];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Typing Effect */}
                <div
                  className="min-h-[4rem] sm:min-h-[3.5rem]"
                  data-aos="fade-up"
                  data-aos-delay="800"
                >
                  ...
                  <span className="w-[3px] h-6 bg-gradient-to-t from-[#6366f1] to-[#a855f7] ml-1 animate-blink inline-block align-text-bottom"></span>
                </div>
